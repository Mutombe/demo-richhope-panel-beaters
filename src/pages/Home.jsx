  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustBadge} &middot; 297 Mccarthy Way &middot; Est. 2015
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Richhope Panel Beaters &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a team of experienced professionals and 24+ satisfied clients, our track record speaks for itself. We bring the same meticulous attention to detail to every single project.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              ...
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">24+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Clients</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">4.3</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Richhope Panel Beaters professional work"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Richhope Panel Beaters detail work"
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80"
              alt="Richhope Panel Beaters quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Richhope</span>
            </h2>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Richhope Panel Beaters services"
        ...
        >
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            ...
            <span className="flex items-center gap-2">
              <MapPin size={14} /> 297 Mccarthy Way
            </span>
          </div>
        </motion.div>
      </div>
